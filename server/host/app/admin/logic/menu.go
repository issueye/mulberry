...
import (
	"carambola/host/app/admin/model"
	"carambola/host/app/admin/requests"
	"carambola/host/app/admin/service"
...
func InitMenus() {
	menus := []*model.Menu{
		model.BaseNewMenu(model.MenuBase{Code: "1000", Name: "任务管理", Description: "任务管理", Frontpath: "/task", Order: 10, Visible: true, Icon: "List", ParentCode: ""}),
		model.BaseNewMenu(model.MenuBase{Code: "1001", Name: "定时任务管理", Description: "任务管理", Frontpath: "/task/task_mana", Order: 11, Visible: true, Icon: "List", ParentCode: "1000"}),
		model.BaseNewMenu(model.MenuBase{Code: "1002", Name: "客户端管理", Description: "客户端管理", Frontpath: "/task/client_mana", Order: 12, Visible: true, Icon: "MessageBox", ParentCode: "1000"}),
		model.BaseNewMenu(model.MenuBase{Code: "1003", Name: "数据库管理", Description: "数据库管理", Frontpath: "/task/db_mana", Order: 13, Visible: true, Icon: "MessageBox", ParentCode: "1000"}),
		model.BaseNewMenu(model.MenuBase{Code: "1004", Name: "执行记录查询", Description: "执行记录查询", Frontpath: "/task/task_log", Order: 14, Visible: true, Icon: "MessageBox", ParentCode: "1000"}),
