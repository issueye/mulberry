...
type PageBase struct {
	...
	Versions        []PageVersionInfo `gorm:"foreignKey:product_code"`
...
// TableName
// 表名称
func (PageInfo) TableName() string { return "bridge_page_info" }
...
// TableName
// 表名称
func (PageVersionInfo) TableName() string { return "bridge_page_version_info" }
